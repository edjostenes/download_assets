...
class FileManagerImpl implements FileManager {
  ...
  @override
  Future<FileSystemEntity> deleteFile(File file, {bool recursive = false}) async => await file.delete();
  ...
  @override
  Future<bool> directoryExists(String directoryPath) async => await Directory(directoryPath).exists();
  ...
  @override
  Future<File> createFileRecursively(File file) async => await file.create(recursive: true);

  @override
  Future<File> writeAsBytes(File file, List<int> bytes) async => await file.writeAsBytes(bytes);
}
